...
jmeter -n -t service-1-test.jmx -l "$REPORT_DIR/results1.jtl" -e -o "$REPORT_DIR"

# Print a message when the test is completed
echo "Test completed. Results saved to $REPORT_DIR/results1.jtl and HTML report generated in $REPORT_DIR/"
